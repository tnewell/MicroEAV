...
namespace EAVFrameworkTest
{
    public partial class EAVFrameworkTestHarness
    {
        ...
        [TestMethod]
        public void TestContextForNewContainer()
        {
        ...
        [TestMethod]
        public void TestContextForUnmodifiedContainer()
        {
            EAVContainer aContainer = new EAVRootContainer();
        ...
        [TestMethod]
        public void TestContextForModifiedContainer()
        {
            EAVContainer aContainer = new EAVRootContainer();
        ...
        [TestMethod]
        public void TestContextForDeletedContainer()
        {
            EAVContainer aContainer = new EAVRootContainer();
        ...
        [TestMethod]
        public void TestContextInteractionWithContainer()
        {
